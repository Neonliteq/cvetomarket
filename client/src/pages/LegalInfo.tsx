    ...
    <div className="max-w-3xl mx-auto px-4 py-10 space-y-10">
      ...
      <Card>
        ...
        <CardContent className="pt-0">
          ...
          <InfoRow label="Сокращённое наименование" value="ИП Аршинская Елена Анатольевна" />
      ...
      <div className="space-y-4">
        ...
        <div className="pl-12 space-y-2 text-sm text-muted-foreground leading-relaxed">
          <p>ИП Аршинская Елена Анатольевна осуществляет деятельность в качестве информационного посредника, обеспечивающего взаимодействие между продавцами (цветочными магазинами) и покупателями посредством маркетплейса ЦветоМаркет.</p>
      ...
      <div className="space-y-4">
        ...
        <div className="pl-12 space-y-2 text-sm text-muted-foreground leading-relaxed">
          <p>Претензии в адрес ИП Аршинская Елена Анатольевна принимаются в письменном виде:</p>
          <ul className="list-disc ml-5 space-y-1 mt-1">
